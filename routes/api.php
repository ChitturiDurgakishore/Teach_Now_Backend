...
Route::prefix('auth')->group(function () {
    ...
    Route::post('/send-email',[PublicAPIController::class, 'sendOtp']);
    Route::post('/verify-email', [PublicAPIController::class, 'verifyOtp']);
});
...
Route::middleware(['auth:sanctum', 'role:admin'])->prefix('admin')->group(function () {
    ...
    Route::patch('/recruiters/{id}/disable', [AdminController::class, 'toggleRecruiterStatus']);
...
Route::middleware(['auth:employer', 'role:employer'])->prefix('employer')->group(function () {
    ...
    Route::get('/jobs/applications/{jobId}', [EmployerController::class, 'getJobApplications']); //specific job applications
